...
class LF_Contact_Form7 extends LF_Lead_Capture {

	function __construct() {
		// add_action( 'wpcf7_mail_sent', array( $this, 'capture_lead') );
		// add_action( 'admin_init', array( $this, 'init_settings'));
		add_action( 'wp_enqueue_scripts', array( $this, 'add_scripts') );
		add_action( 'wp_ajax_nopriv_cf7_capture_lead', array( $this, 'cf7_capture_lead' ) );
		add_action( 'wp_ajax_cf7_capture_lead', array( $this, 'cf7_capture_lead' ) );
		add_action( 'admin_init', array( $this, 'init_settings'));
	}
	 ...
	 *
	 */
	public function cf7_capture_lead( ) {

		$lead['provider'] = "Contact Form7";
	 ...
	 */
	 public function settings_section_text() {
		 echo '<h2>Contact Form7 Settings</h2><p>Please provide the IDs for the following fields.</p>';
	 }
	...
	public function add_scripts() {
		...
		wp_enqueue_script( 'lf_cf7', LEADFERRY_URL . '/leads/classes/vendors/js/cf7.js', '', '', true );
		wp_localize_script( 'lf_cf7', 'local_data', $local_data );
	}
}
$contact_form7 = new LF_Contact_Form7();
