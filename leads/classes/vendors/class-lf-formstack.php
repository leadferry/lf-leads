...
class LF_Formstack extends LF_Lead_Capture {
	...
	public function init_settings(){
		register_setting( 'lf_lead_capture_options', 'lf_formstack_options', array( $this, 'validate_options' ) );
	...
	public function validate_options( $input ) {
		...
		$options = get_option( 'lf_formstack_options' );
	...
	public function settings_section_text() { ?>
		<h2>Formstack Settings</h2>
		<p>Please provide the values of name attributes for the follwing fields in your formstack form. </p>
	...
	public function lf_lead_form_id_callback() {
		...
		echo '<input id="lf_lead_form_id" name="lf_formstack_options[lead_form_id]" size="40" type="text" value="'. $lead_form_id .'">';
	}
	...
	public function lf_lead_first_name_callback() {
		...
		echo '<input id="lf_lead_first_name" name="lf_formstack_options[lead_first_name]" size="40" type="text" value="'. $lead_first_name .'">';
	}
	...
	public function lf_lead_last_name_callback() {
		...
		echo '<input id="lf_lead_last_name" name="lf_formstack_options[lead_last_name]" size="40" type="text" value="'. $lead_last_name .'">';
	}
	...
	public function lf_lead_email_callback() {
		...
		echo '<input id="lf_lead_email" name="lf_formstack_options[lead_email]" size="40" type="text" value="'. $lead_email .'">';
	}
	...
	public function add_scripts() {
		...
		wp_localize_script( 'lf_formstack', 'local_data', $local_data );
	}
}
