...
class LF_Leadsquared extends LF_Lead_Capture {

	function __construct() {
		add_action( 'wp_enqueue_scripts', array( $this, 'add_scripts') );
		add_action( 'wp_ajax_nopriv_leadsquared_capture_lead', array( $this, 'leadsquared_capture_lead' ) );
		add_action( 'wp_ajax_leadsquared_capture_lead', array( $this, 'leadsquared_capture_lead' ) );
	...
	public function lf_lead_form_id_callback() {
		...
		echo '<input id="lf_lead_form_id" name="lf_leadsquared_options[lead_form_id]" size="40" type="text" value="'. $lead_form_id .'">';
	}
	...
	public function lf_lead_first_name_callback() {
		...
		echo '<input id="lf_lead_first_name" name="lf_leadsquared_options[lead_first_name]" size="40" type="text" value="'. $lead_first_name .'">';
	}
	...
	public function lf_lead_last_name_callback() {
		...
		echo '<input id="lf_lead_last_name" name="lf_leadsquared_options[lead_last_name]" size="40" type="text" value="'. $lead_last_name .'">';
	}
	...
	public function lf_lead_email_callback() {
		...
		echo '<input id="lf_lead_email" name="lf_leadsquared_options[lead_email]" size="40" type="text" value="'. $lead_email .'">';
	}
	...
	public function add_scripts() {
		...
		wp_enqueue_script( 'lf_leadsquared', LEADFERRY_URL . '/leads/classes/vendors/js/leadsquared.js', '', '', true );
		wp_localize_script( 'lf_leadsquared', 'local_data', $local_data );
	}
}

$leadsquared = new LF_Leadsquared();
