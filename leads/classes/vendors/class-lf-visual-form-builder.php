...
class LF_Visual_Form_Builder extends LF_Lead_Capture {
	...
	public function vfb_capture_lead() {
		...
		$lead['provider'] = "visual_form_builder";
	...
	public function init_settings(){
		register_setting( 'lf_lead_capture_options', 'lf_vfb_options', array( $this, 'validate_options' ) );
	...
	public function validate_options( $input ) {
		...
		$options = get_option( 'lf_vfb_options' );
	...
	public function settings_section_text() {
		echo '<h2>Visual Form Builder Settings</h2><p>Please provide the ID for the follwing fields in your Visual Form Builder form. </p>';
	 }
	...
	public function lf_lead_form_id_callback() {
		...
		echo '<input id="lf_lead_form_id" name="lf_vfb_options[lead_form_id]" size="40" type="text" value="'. $lead_form_id .'">';
	}
	...
	public function lf_lead_first_name_callback() {
		...
		echo '<input id="lf_lead_first_name" name="lf_vfb_options[lead_first_name]" size="40" type="text" value="'. $lead_first_name .'">';
	}
	...
	public function lf_lead_last_name_callback() {
		...
		echo '<input id="lf_lead_last_name" name="lf_vfb_options[lead_last_name]" size="40" type="text" value="'. $lead_last_name .'">';
	}
	...
	public function lf_lead_email_callback() {
		...
		echo '<input id="lf_lead_email" name="lf_vfb_options[lead_email]" size="40" type="text" value="'. $lead_email .'">';
	}
	...
	public function add_scripts() {
		...
		wp_localize_script( 'lf_vfb', 'local_data', $local_data );
	}
}
